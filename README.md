Concrete implementation of [flutter_fit_utils](https://pub.dev/packages/flutter_fit_utils) for Hive.
...
Feel free to [give any feedback](https://github.com/Vaistudio-dev/fit_hive/issues) ! This package is also open to contributions.